...
public class AlarmController extends JeecgController<Alarm, IAlarmService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "气体报警-分页列表查询")
	@ApiOperation(value="气体报警-分页列表查询", notes="气体报警-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "气体报警-添加")
	@ApiOperation(value="气体报警-添加", notes="气体报警-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "气体报警-编辑")
	@ApiOperation(value="气体报警-编辑", notes="气体报警-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "气体报警-通过id删除")
	@ApiOperation(value="气体报警-通过id删除", notes="气体报警-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "气体报警-批量删除")
	@ApiOperation(value="气体报警-批量删除", notes="气体报警-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "气体报警-通过id查询")
	@ApiOperation(value="气体报警-通过id查询", notes="气体报警-通过id查询")
  ...
  public ModelAndView exportXls(HttpServletRequest request, Alarm alarm) {
      return super.exportXls(request, alarm, Alarm.class, "气体报警");
  }
