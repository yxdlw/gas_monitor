package org.jeecg.modules.demo.gas.controller;
...
public class ConcentrationController extends JeecgController<Concentration, IConcentrationService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "气体浓度-分页列表查询")
	@ApiOperation(value="气体浓度-分页列表查询", notes="气体浓度-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "气体浓度-添加")
	@ApiOperation(value="气体浓度-添加", notes="气体浓度-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "气体浓度-编辑")
	@ApiOperation(value="气体浓度-编辑", notes="气体浓度-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "气体浓度-通过id删除")
	@ApiOperation(value="气体浓度-通过id删除", notes="气体浓度-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "气体浓度-批量删除")
	@ApiOperation(value="气体浓度-批量删除", notes="气体浓度-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "气体浓度-通过id查询")
	@ApiOperation(value="气体浓度-通过id查询", notes="气体浓度-通过id查询")
  ...
  public ModelAndView exportXls(HttpServletRequest request, Concentration concentration) {
      return super.exportXls(request, concentration, Concentration.class, "气体浓度");
  }
